...
<html lang="en">
    <head>
        ...
        <title>Recuperar contraseña - Pig Farm🐷</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Ingresa tu correo electronico para enviar el link y actualizar tu contraseña</div>
                                        <form>
